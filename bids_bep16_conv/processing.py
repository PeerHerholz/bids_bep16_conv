...
def fsl_dti(input_files, bval, bvec, mask, outdir, outname):
    """
    ...
    Returns
    -------
    Output files generated by FSL's dtifit in specified output directory .

    Examples
    --------
    Run dtifit on local data and save it to the Desktop.

    >>> fsl_dti('sub-01_desc-preproc_dwi.nii.gz',
                 'sub-01_desc-preproc_dwi.bval',
                 'sub-01_desc-preproc_dwi.bvec',
                 'sub-01_desc-brain_mask.nii.gz',
                 '/home/user/Desktop)
    ...
    # create the command
    cmd = ["dtifit", "-k", input_files, "-b", bval, "-r", bvec,
           "-m", mask, "-o", outname, "--save_tensor"
           ]
    check_call(cmd)
    return
